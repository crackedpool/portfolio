...
export default async function Page({
  ...
  return (
    <div className={`flex flex-col gap-[15px] ${project.images ? "" : "justify-center"} w-full relative`}>
      <div className='flex justify-center items-center sticky top-0 bg-[var(--background-color)]/40 py-2 backdrop-blur-sm'>
        <Link href="/" className='absolute bb left-0 inset-y-0 flex gap-1 items-center cursor-pointer hover:opacity-50'>
